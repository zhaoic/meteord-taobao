...
TARBALL_URL="https://7xs3j2.com1.z0.glb.clouddn.com/packages-bootstrap/${RELEASE}/meteor-bootstrap-${PLATFORM}.tar.gz"
...
curl --progress-bar --insecure --fail "$TARBALL_URL" | tar -xzf - -C "$INSTALL_TMPDIR" -o
